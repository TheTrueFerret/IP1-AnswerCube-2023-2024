...
(() => {
/*!*****************************************!*\
  !*** ./src/ts/flow/slide/StartSlide.ts ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
...
function InitializeFlow() {
    fetch((0,_urlDecoder__WEBPACK_IMPORTED_MODULE_0__.RemoveLastDirectoryPartOf)(url) + "/InitializeFLow/", {
        method: "GET",
        headers: {
        ...
        if (data && data.token) {
            ...
            (0,_CookieHandler__WEBPACK_IMPORTED_MODULE_1__.setCookie)("jwtToken", data.token, 1); // Change 1 to the number of days you want the cookie to last
        }
    }).catch((error) => {
        console.error(error);
        if (slideElement) {
...
/******/ })()
;
//# sourceMappingURL=startslide.entry.js.map