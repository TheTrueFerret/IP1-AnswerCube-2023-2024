...
!function() {
/*!****************************************!*\
  !*** ./src/ts/flow/slide/SubThemes.ts ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _urlDecoder__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../urlDecoder */ "./src/ts/urlDecoder.ts");

var url = window.location.toString();
function chooseSlideList(slideListId) {
    let requestBody = {
        Id: slideListId
    };
    console.log(requestBody);
    fetch((0,_urlDecoder__WEBPACK_IMPORTED_MODULE_0__.RemoveLastDirectoryPartOf)(url) + "/ChooseSlideList", {
        method: "POST",
        headers: {
...
document.querySelectorAll('.ChooseSlideList').forEach((btnSubmit) => {
    btnSubmit.addEventListener('click', function () {
        chooseSlideList(Number(btnSubmit.getAttribute('data-info')));
    });
});
...
/******/ })()
;
//# sourceMappingURL=subtheme.entry.js.map