...
!function() {
/*!******************************************!*\
  !*** ./src/ts/InitializeInstallation.ts ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var bootstrap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! bootstrap */ "./node_modules/bootstrap/dist/js/bootstrap.esm.js");
/* harmony import */ var _urlDecoder__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./urlDecoder */ "./src/ts/urlDecoder.ts");
/* harmony import */ var _CookieHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./CookieHandler */ "./src/ts/CookieHandler.ts");



let url = window.location.toString();
const jwtToken = (0,_CookieHandler__WEBPACK_IMPORTED_MODULE_2__.getCookie)("jwtToken");
let installationSelectElement = document.getElementById("inactiveInstallations");
let installationName = document.getElementById("installationName");
let installationLocation = document.getElementById("installationLocation");
let organisationSelectElement = document.getElementById("organisations");
...
if (createInstallationButton && saveInstallationButton && createInstallationModalElement &&
    ...
    const createInstallationModal = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Modal(createInstallationModalElement);
...
function submitInstallation() {
    ...
    fetch((0,_urlDecoder__WEBPACK_IMPORTED_MODULE_1__.RemoveLastDirectoryPartOf)(url) + "/SetInstallationToActive", {
        method: "POST",
        headers: {
        ...
        if (data && data.token) {
            (0,_CookieHandler__WEBPACK_IMPORTED_MODULE_2__.setCookie)("jwtToken", data.token, 7);
        }
        if (data.url) {
...
function CreateNewInstallation() {
    ...
    console.log(requestBody);
    fetch((0,_urlDecoder__WEBPACK_IMPORTED_MODULE_1__.RemoveLastDirectoryPartOf)(url) + "/CreateInstallation", {
        method: "POST",
        headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
...
/******/ })()
;
//# sourceMappingURL=initializeinstallation.entry.js.map